...
def commands_dispatcher(operation: str):
    ...
    if operation not in operations:
        raise Exception(f"Operation: '{operation}' is forbidden\n")
    ...
    if operation == "exit":
        ...
        user_data = input("Enter new player info[name,age,number]: ")
        ...
        user_it: list[str] = user_data.split(",")
        name, age, number = user_it
        try:
